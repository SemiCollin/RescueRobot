...
// Base driving speeds
// #define BASE_SPEED_L 38
// #define BASE_SPEED_R 20


// would like to try a higher speed, sometimes getting caught with weak motor drive and will stop moving
#define BASE_SPEED_L 53
#define BASE_SPEED_R 35

// Target Colour readings
#define TARGET_R 56
#define TARGET_G 108
#define TARGET_B 90
...
void motor_control(float PID , int speed_L , int speed_R);
